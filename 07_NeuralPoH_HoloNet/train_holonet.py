...
p.add_argument('--data_path', type=str, default='./data/DIV2K/train', help='data directory path for training')
...
wavelength = (660 * nm, 532 * nm, 473 * nm)[channel]
...
data_path = opt.data_path  # path for training data
...
for i in range(opt.num_epochs):
    ...
    for k, target in enumerate(tqdm(image_loader)):
